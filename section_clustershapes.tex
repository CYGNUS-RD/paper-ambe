...
\begin{itemize}
    ...
    \begin{figure}[ht]
      \begin{center}
        ...
        \caption{Supercluster profile in the longitudinal (top) or
          ...
          cosmic ray track candidate. The longitudinal profile shows
  ...
  \item \textit{Gaussian width:~} the true width of the track in the
    transverse direction is expected to be much lower than the width
    induced by the diffusion in the gas. Thus, as shown in
    Fig.~\ref{fig:profiles} (bottom), the standard
