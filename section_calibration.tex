...
%% The distributions were obtained for nuclear
%% recoils with $E=6\keV$ generated at the exact center of the \lemon
%% detector. The mean and the Gaussian width of the peak are estimated by
%% fitting the distributions with a Crystal Ball
...
%% Despite this, the resolution in presence of noise and diffusion is
%% estimated in this simulated nuclear recoils with $E=6\keV$ to be
%% around 4\%.
